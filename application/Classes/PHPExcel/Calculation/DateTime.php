...
class PHPExcel_Calculation_DateTime {
	 ...
	 */
	public static function YEARFRAC_NRB($startDate = 0, $endDate = 0, $method = 0) {
		...
		if (((is_numeric($method)) && (!is_string($method))) || ($method == '')) {
			...
			switch($method) {
				...
				case 1	:
					...
					$res=(int)$days / (365 + (int)$leapDays);
					return $res;
					break;
				case 2	:
					return (int)self::DATEDIF($startDate,$endDate) / 360;
					break;
				case 3	:
					return (int)self::DATEDIF($startDate,$endDate) / 365;
					break;
				case 4	:
					return (int)self::DAYS360($startDate,$endDate,True) / 360;
					break;
			}
		}
		return PHPExcel_Calculation_Functions::VALUE();
