...
/* .center {
  ...
  padding: 10px;
    ...
    <script type="text/javascript">
            ...
            jQuery("#zone").jqxComboBox({theme: theme, promptText: "Select zone", source: zone, width: 150, height: 25});
            ...
            jQuery("#loan_segment").jqxComboBox({theme: theme, promptText: "Select Investment segment", source: loan_segment, width: 150, height: 25});
            jQuery('#zone,#loan_segment,#territory,#district,#unit_office').focusout(function() {
                                               ...
                                               <div  style="padding: 0px;width:100%;height: 115px;border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                                                    <table id="deal_body" style="display:block;width:90%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:5%"><div style="padding-left:1.8%" id="zone" name="zone"></div></td>
                                                        ...
                                                        <tr>
                                                            <td style="text-align:left;width:10%" colspan="2"><strong>Filling From&nbsp;</strong><input type="text" name="filling_dt_from" placeholder="dd/mm/yyyy" style="width:100px;" id="filling_dt_from" value="" ><script type="text/javascript" charset="utf-8">datePicker ("filling_dt_from");</script> </td>
                                        ...
                                        <table class="" table border="1" id="facility_table" style="border-color:#c0c0c0;" >
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Legal zone</td>
