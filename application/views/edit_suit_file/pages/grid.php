...
/* .center {
  ...
  padding: 10px;
    ...
    <script type="text/javascript">
            ...
            jQuery("#branch_sol").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Select Branch", source: branch_sol, width: 250, height: 25});
           ...
           jQuery('#proposed_type,#final_remarks,#proposed_type_grid,#req_type_grid,#next_date_sts_grid,#zone,#district,#loan_segment,#branch_sol').focusout(function() {
                   ...
                   datafields: [
                    ...
                    jQuery("#jqxgrid").jqxGrid(
                    {
                        ...
                        columns: [
                                ...
                                { text: 'Branch', datafield: 'branch_name',editable: false, width: '10%', align:'left',cellsalign:'left'},
        ...
        jQuery.ajax({
            ...
            success: function(response){
                ...
                if(json.Message=='ok'){
                    ...
                    if(json.row_info.case_sts_next_dt!='' && json.row_info.case_sts_next_dt!=0)
                    {
                    ...
                    jQuery("#ac_no").val(json.row_info.loan_ac);
                    jQuery("#account_name").val(json.row_info.ac_name);
                    ...
                    jQuery("#zone").jqxComboBox('val',json.row_info.zone);
                    jQuery("#district").jqxComboBox('val',json.row_info.district);
                    jQuery("#branch_sol").jqxComboBox('val',json.row_info.branch_sol);
                    ...
                    jQuery('#remarks_prev_date').val(json.row_info.remarks_prev_date);
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="50%">
                                                                    <table style="width: 100%;">
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" > <input type="text" id="ac_no" name="ac_no" style="width:250px;"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="40%" style="font-weight: bold;">Name</td>
                                                                            <td width="60%" > <input type="text" id="account_name" name="account_name" style="width:250px;"></td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr id="next_remarks_row">
                                                                            ...
                                                                            <td width="60%" ><textarea name="remarks_prev_date" tabindex="9" class="text-input-big" id="remarks_prev_date" style="height:40px !important;width:250px"></textarea></td>
                                                                        </tr> 
                                                                        <tr id="next_dt_row">
                                                                ...
                                                                <td width="50%" style="display: table-row;">
                                                                    ...
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">Filing Plaintiff</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" ><div id="zone" name="zone" style="padding-left: 3px" tabindex="9"></div></td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" ><div id="branch_sol" name="branch_sol" style="padding-left: 3px" tabindex="9"></div></td>
                                                                        </tr>
