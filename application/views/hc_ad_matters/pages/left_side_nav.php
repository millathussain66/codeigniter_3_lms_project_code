                    ...
                    <div class='navigationItem'>
                        <ul class='navigationContent'>
                            <li class='navigationItemContent <?php if($submenu=='hc_case_file' || $submenu==null){echo 'active';} ?>'><a href="<?php echo base_url('hc_ad_matters/view/'.$menu_group.'/'.$menu_cat.'/'.$menu_link.'/'); ?>hc_case_file">Case Filling</a></li>
                            <li class='navigationItemContent <?php if($submenu=='case_status_update'){echo 'active';} ?>'><a href="<?php echo base_url('hc_ad_matters/view/'.$menu_group.'/'.$menu_cat.'/'.$menu_link.'/'); ?>case_status_update">Case Status Update</a></li>
                            ...
                            <li class='navigationItemContent <?php if($submenu=='case_details'){echo 'active';} ?>'><a href="<?php echo base_url('hc_ad_matters/view/'.$menu_group.'/'.$menu_cat.'/'.$menu_link.'/'); ?>case_details">Case Details</a></li>
