...
<? if ($option == 'daily_report') { ?>
    <script language="javascript" type="text/javascript">
        jQuery().ready(function() {
            ...
            <?php //$url
            ?>
            //jQuery('#inXLadfc').attr('href','<?php //base_url()
                                                ?>index.php/legal_notice_rt/mk_xl_daily_report');
                ...
                <form method="POST" name="form" id="daily_report_search" style="margin:0px;" action="<?= base_url() ?>index.php/legal_notice_rt/daily_report/<?= $menu_group ?>/<?= $menu_cat ?>">
                    ...
                    <div style="padding: 0.5%;width:98%;height:60px; border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                        ...
                        <table id="deal_body" style="display:block;width:100%">
                            ...
                            <td style="width:15%"><input id="appFromDate" name="appFromDate" value="<? //=$appFromDate
                                                                                                    ?>" style="width:40%" /><script type="text/javascript">datePicker("appFromDate");</script>
                            <strong>To</strong> <input id="appToDate" name="appToDate" value="<? //=$appToDate
                                                                                                ?>"  style="width:40%" /><script type="text/javascript" >datePicker("appToDate");</script>
                            </td> -->
                                    ...
                                    <div style="padding-left:1.8%">
                                        <select id="col_xl" tabindex="16" name="col_xl[]" multiple="multiple" style="width:180px">
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(1, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="1">SL No.</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(2, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="2">Proposed Type</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(3, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="3">Loan A/C No.</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(4, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                            ...
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(5, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="5">Branch Code</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(6, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="6">Loan A/C Name</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(7, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="7">Business Type</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(8, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="8">Spouse Name</option>
                                            <!--option <?php //if(!empty($col_xl)){if(in_array(9,$col_xl)){echo 'selected';}}else{echo 'selected';}
                                                        ?> value="9">Father Name</option-->
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(10, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="10">Mother Name</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(11, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="11">Investment Segment (Portfolio)</option>
                                            <!--option <?php //if(!empty($col_xl)){if(in_array(12,$col_xl)){echo 'selected';}}else{echo 'selected';}
                                                        ?> value="12">Permanent Address</option>
                                    <option <?php //if(!empty($col_xl)){if(in_array(13,$col_xl)){echo 'selected';}}else{echo 'selected';}
                                            ?> value="13">Present Address</option>
                                    <option <?php //if(!empty($col_xl)){if(in_array(14,$col_xl)){echo 'selected';}}else{echo 'selected';}
                                            ?> value="14">Business Address</option-->
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(15, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="15">Current/Updated Address</option>
                                            <!--option <?php //if(!empty($col_xl)){if(in_array(16,$col_xl)){echo 'selected';}}else{echo 'selected';}
                                                        ?> value="16">Summon Send To</option-->
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(17, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="17">zone</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(19, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="19">District</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(21, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="21">Hold Reason</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(22, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="22">More A/C No.</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(23, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="23">Remarks</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(24, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="24">Status</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(25, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="25">Initiate By</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(26, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="26">Initiate Date Time</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(27, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="27">STC By</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(28, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="28">STC Date Time</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(29, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="29">Recommended By</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(30, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="30">Recommend Date Time</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(31, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="31">Acknowledge By</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(32, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="32">Acknowledge Date Time</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(33, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="33">Send To HOLM By</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(34, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="34">Send To HOLM Date Time</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(35, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="35">Verify By</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(36, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="36">Verify Date Time</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(37, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="37">Customer Contact</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(38, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="38">Legal Notice sent by</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(39, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="39">Legal Notice sent Date</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(40, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="40">Lawyer Name</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(41, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="41">Call up Date</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(42, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="42">LN Serial</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(43, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="43">Guarantor</option>
                                            <option <?php if (!empty($col_xl)) {
                                                        if (in_array(44, $col_xl)) {
                                                            echo 'selected';
                                                        }
                                                    } else {
                                                        echo 'selected';
                                                    } ?> value="44">Facility Details</option>
                                        </select>
                                        <script>
                    ...
                    <? if ($post_sts == 1) { ?>
                        <table style="font-size:10pt" width="100%" class="input_box" border="0" cellspacing="0" cellpadding="1" align="center">
                            <tr style="text-align:left; font-weight:bold; background-color: #B8E4F3; border-color: #ccc">
                                ...
                                <th align="left">Investment AC</th>
