                    ...
                    <div id="body">
                        ...
                        <div style="float:left;padding-top: 5px;">
                            <div style="font-family: Calibri; margin: 0 0 -10px 0;font-size:14px;color:#0000cc">
                                <? if (VERIFY == 1) { ?>
                                    <a style="text-decoration:none" onclick="javascript:EOL.messageBoard.open(this.href, (jQuery(window).width()-70), jQuery(window).height(), 'yes'); return false;" href="<?= base_url() ?>bill_approve_ho/bulk_operation/apv/court_fee" title=""><input type="button" class="buttonStyle" style="background-color:#c2c2bc;font-size:13px;border-radius: 3px !important;height:30px;width:100px;" value="BULK APV" id="sendButton" /></a>
                                    <? } ?>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <script type="text/javascript">
        ...
        var initGrid2 = function() {
            var source = {
                ...
                url: '<?= base_url() ?>bill_approve_ho/court_fee_grid',
                cache: false,
                filter: function() {
