...
function search_data(){
    ...
    else
    {
        ...
        jQuery.ajax({
            ...
            cache: false,
            async:false,
            url: "<?=base_url()?>index.php/wa_rt/month_region_rt/",
            data : postdata,
            datatype: "html",
        ...
        <table class="">
            <tr id="widgetsNavigationTree">
                ...
                <td valign="top" id="demos" class='rc-all content'  style="width:85%;overflow: hidden;">
                    <div id="search_area">
                    <form method="POST" name="form" id="form" action="<?php echo base_url('wa_rt/month_region_rt_xl'); ?>"  style="margin:0px;">
                    ...
                    <div id="searchTable"  style="border:1px solid #000;max-width: 1120px;overflow: hidden;overflow: scroll;display: none;height: 375px;"></div>
                </td>
            </tr>
        </table>
    </div>
