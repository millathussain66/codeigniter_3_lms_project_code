...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        jQuery("#both_case").jqxCheckBox({
            width: 22,
            theme: theme,
            checked: false
        });
        jQuery("#merge_case").jqxCheckBox({
            width: 22,
            theme: theme,
            checked: true
        });
        jQuery("#merge_case_sts").val(1);
        jQuery('#proposed_type,#legal_zone,#proposed_type_grid,#next_date_sts_grid,#req_type_grid').focusout(function() {
                ...
                columns: [{
                    ...
                    <? if (RECASEFILEDELETE == 1) { ?> {
                            ...
                            cellsrenderer: function(row) {
                                ...
                                } else if (<?= RECASEFILEDELETE ?> == '1' && (<?= $this->session->userdata['ast_user']['user_work_group_id'] ?> == 11 || <?= $this->session->userdata['ast_user']['user_work_group_id'] ?> == 10)) {
        ...
        jQuery("#details").jqxWindow({
            ...
            isModal: true,
            autoOpen: false,
            cancelButton: jQuery("#codeOK,#SendTocheckercancel,#sendnotificationcancel,#authorization_cancel,#confirm_cancel,#reassigncancel,#closeaccount_cancel,#deletecancel,#nextdatecancel,#reassign_approval_cancel")
        });
            ...
            rules: [{
                    ...
                    rule: function(input) {
                        if (input.val() != '') {
                            var item = jQuery("#case_name").jqxComboBox('getSelectedItem');
                            if (item != null) {
                                jQuery("input[name='case_name']").val(item.value);
                            }
                            return true;
                        } else {
                ...
                },
                {
                    ...
                    rule: function(input, commit) {
                        if (input.val() != '') {
                            if (!checknumber_alphabatic('decree_amount')) {
                                jQuery("#decree_amount").focus();
                                return false;
    ...
    function searchsuit() // customer search 
    {
        ...
        var search_case_number = jQuery('#search_case_number').val();
        if (item != null && loan_ac == '' && search_case_number == '') {
            alert('please provide Investment/Card Number/Case Number');
            ...
            return false;
        } else if (loan_ac == '' && search_case_number == '') {
            ...
            jQuery.ajax({
                ...
                data: {
                    ...
                    req_type: req_type,
                    loan_ac: loan_ac,
                    case_number: search_case_number,
                    hidden_loan_ac: hidden_loan_ac
                },
                datatype: "html",
                success: function(response) {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                if (json.Message == 'ok') {
                    ...
                    jQuery("#case_name").jqxComboBox({
                        theme: theme,
                        autoOpen: false,
                        autoDropDownHeight: false,
                        promptText: "Case Name",
                        source: case_name,
                        width: 250,
                        height: 25
                    });
                    ...
                    jQuery('#decree_date').jqxComboBox('val', json.row_info.decree_date);
                    ...
                    jQuery("#decree_amount").val(json.row_info.decree_amount);
                    ...
                    if (json.row_info.merge_case_sts == 1) {
                        ...
                        var full_case_number = new_case_number;
                        var str = full_case_number.split("/");
                        ...
                        jQuery("#merge_case_sts").val(0);
                        var full_case_number = json.row_info.case_number;
                        var str = full_case_number.split("/");
                        var case_number = str[0];
                        var year = str[1];
                    }
    ...
    function load_filing_info(cma_id = null) {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                jQuery('#req_type_val_calculation').val(json.suit_info.req_type);
                jQuery('#cma_info_district').val(json.suit_info.district);
    ...
    function get_expense_amount(act_id, cma_district, counter, req_type, vendor_data=null) {
        var theme = getDemoTheme();
    ...
    function make_expense_jari() {
        ...
        for (var i = 1; i <= 3; i++) {
            ...
            if (i == 1) //For Drafting COST
            {
                ...
                get_expense_amount('activities_name_' + new_counter, suit_district, new_counter, suit_req_type, 'vendor_id_' + new_counter);
            }
    ...
    function show_confrimation_pop_up() {
        ...
        $('loadingReturn').style.display = 'none';
        sendToCheckerMessageDialog = new EOL.dialog($('sendToCheckerMessageDialogContent2'), {
            position: 'fixed',
            modal: true,
            width: 470,
            close: true,
                                    ...
                                    <div id="search_area">
                                        <form method="POST" name="form" id="form" style="margin:0px;">
                                            ...
                                            <div style="padding: 0px;width:100%;height:50px; border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                                                <table id="deal_body" style="display:block;width:95%">
                                                    <tr>
                                                        <td style="text-align:right;width:9%"><strong>Type Of Case&nbsp;&nbsp;</strong> </td>
                                                        <td>
                                                            <div style="padding-left:1%" id="req_type" name="req_type"></div>
                                                        </td>
                                                        <td style="text-align:right;"><strong>Proposed Type&nbsp;&nbsp;</strong> </td>
                                                        <td>
                                                            <div style="padding-left:1.8%" id="proposed_type" name="proposed_type"></div>
                                                        </td>
                                                        <td style="text-align:right;"><strong><span id="l_or_c_no"></span> No.</strong></td>
                                                        ...
                                                        <td style="text-align:right;"><strong>Case Number</strong></td>
                                                        <td style="width:10%"><input name="case_number" tabindex="" type="text" class="" maxlength="" size="" style="width:100px" id="search_case_number" value="" onKeyUp="" /></td>
                                                            ...
                                                            <td width="50%">
                                                                <table style="width: 100%;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="60%">
                                                                            <div id="case_name" name="case_name" style="padding-left: 3px" tabindex="1"></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">New Filing Date<span style="color:red">*</span></td>
                                                                        <td width="60%"><input type="text" name="filling_date" tabindex="2" onchange="set_expense_date('filling_date','','1')" placeholder="dd/mm/yyyy" style="width:250px;" id="filling_date" value="">
                                                                            <script type="text/javascript" charset="utf-8">
                                                                                datePicker_without_advance("filling_date");
                                                                            </script>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">Decree Date</td>
                                                                        <td width="60%"><input type="text" name="decree_date" tabindex="4" placeholder="dd/mm/yyyy" style="width:250px;" id="decree_date" value="">
                                                                            <script type="text/javascript" charset="utf-8">
                                                                                datePicker("decree_date");
                                                                            </script>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">Decree Amount</td>
                                                                        <td width="60%"><input name="decree_amount" type="text" tabindex="4" class="" style="width:250px" id="decree_amount" value="" /></td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <td width="50%">
                                                                <table style="width: 100%;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="60%">
                                                                            <input type="text" name="next_date" tabindex="5" placeholder="dd/mm/yyyy" style="width:225px;" id="next_date" value="">
                                                                            <script type="text/javascript" charset="utf-8">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="60%">
                                                                            <div id="case_sts_next_dt" name="case_sts_next_dt" style="padding-left: 3px" tabindex="6"></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr id="both_case_row">
                                                                        <td width="40%" style="font-weight: bold;">Both Case Running</td>
                                                                        <td width="60%">
                                                                            <div name="both_case" tabindex="7" id="both_case" style="float:left; margin: 3px 0px 0 0;"></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">Previous Case Merge With New Case</td>
                                                                        <td width="60%">
                                                                            <div name="merge_case" tabindex="8" id="merge_case" style="float:left; margin: 3px 0px 0 0;"></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">Filing Plaintiff<span style="color:red">*</span> </td>
                                                                        <td width="60%">
                                                                            <div id="filling_plaintiff" name="filling_plaintiff" style="padding-left: 3px" tabindex="9"></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">Present Lawyer Name<span style="color:red">*</span> </td>
                                                                        <td width="60%">
                                                                            <div id="prest_lawyer_name" name="prest_lawyer_name" style="padding-left: 3px" tabindex="10"></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">Present Name Of The Court<span style="color:red">*</span> </td>
                                                                        <td width="60%">
                                                                            <div id="prest_court_name" name="prest_court_name" style="padding-left: 3px" tabindex="11"></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="float:left;padding-top: 5px;">
                                    <div style="font-family: Calibri; margin: 0 0 -10px 0;font-size:14px;color:#0000cc">
                                        <? if (RECASEFILECONFIRM == 1) { ?>
                                            <a style="text-decoration:none" onclick="javascript:EOL.messageBoard.open(this.href, (jQuery(window).width()-70), jQuery(window).height(), 'yes'); return false;" href="<?= base_url() ?>index.php/legal_file_process/bulk_operation_recase/confirm" title=""><input type="button" class="buttonStyle" style="background-color:#c2c2bc;font-size:13px;border-radius: 3px !important;height:30px;width:100px;" value="BULK Confirm" id="sendButton" /></a>
                                            <? } ?>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <? if (REASSIGN == 1) { ?>
                                                <a style="text-decoration:none" onclick="javascript:EOL.messageBoard.open(this.href, (jQuery(window).width()-70), jQuery(window).height(), 'yes'); return false;" href="<?= base_url() ?>index.php/legal_file_process/bulk_operation_suit_file/blk_rf_recase" title=""><input type="button" class="buttonStyle" style="background-color:#c2c2bc;font-size:13px;border-radius: 3px !important;height:30px;width:80px;" value="Bulk RF" /></a>
                                                <? } ?>&nbsp;&nbsp;
                                                <? if (APPROVEREASSIGN == 1) { ?>
                                                    <a style="text-decoration:none" onclick="javascript:EOL.messageBoard.open(this.href, (jQuery(window).width()-70), jQuery(window).height(), 'yes'); return false;" href="<?= base_url() ?>index.php/legal_file_process/bulk_operation_suit_file/blk_rf_approve_recase" title=""><input type="button" class="buttonStyle" style="background-color:#c2c2bc;font-size:13px;border-radius: 3px !important;height:30px;width:80px;" value="Bulk AR" /></a>
                                                    <? } ?>&nbsp;
...
<div id="sendToCheckerMessageDialogContent2" style="display:none;">
    <form method="POST" name="" id="" style="margin-top:0px;">
        ...
        <div class="hd">
            <h2 class="conf" style="margin-top:0px">Are you sure previous case & new case both are wants to running/ আপনি কি নিশ্চিত যে পূর্ববর্তী কেস এবং নতুন কেস উভয়ই চলছে</h2>
        </div>
