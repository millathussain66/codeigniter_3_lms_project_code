...
/* .center {
  ...
  padding: 10px;
    ...
    <script type="text/javascript">
            ...
            var plaintiff = [<? $i=1; foreach($plaintiff as $row){ if($i!=1){echo ',';} echo '{value:"'.$row->id.'", label:"'.$row->name.'"}'; $i++;}?>];
    ...
    {   
        ...
        else
        {
            ...
            var item = jQuery("#proposed_type_f").jqxComboBox('getSelectedItem');
            if (item.value=='Investment') {
                jQuery("#l_or_c_no_f").html('Investment A/C ');
            }
            else if(item.value=='Card'){
    ...
    function clear_form() {
        ...
        jQuery("#defendant_name").val('Al-Arafah Islami Bank PLC');
        jQuery("#loan_ac_f").val('');
