                ...
                <td valign="top" id="demos" class='rc-all content'>
                    ...
                    <div>
                        <div style="display:block; height:auto">
                            <form method="POST" name="form" id="daily_report_search" style="margin:0px;" action="<?php echo base_url('bb_rt/xl_download/statement_rt'); ?>">
                                    ...
                                    <table id="deal_body" style="display:block;width:100%">
                                        <tr>
                                            ...
                                            <td><input style="display: none;" name="submit" id="submit" class="crmbutton small create" value="Search Now" type="button" onclick="search_data()">
                                                ...
                                                <button type="submit" id="xl_search" style="" formtarget="_blank" name="mk_xl"><img width="20px" height="20px" align="center" src="<?= base_url() ?>images/word_icon.gif"></button>
