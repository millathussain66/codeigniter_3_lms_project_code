								...
								<tbody>
									...
									foreach ($cma_mortgage as $key) { ?>
										<tr>
											...
											<td>
												<div style="cursor:pointer" onclick="delete_record_message('mortgage_delete',<?= $key->id ?>,<?= $key->cma_id ?>);"><img align="center" src="<?= base_url() ?>images/delete-New.png"></div>
											</td>
											<td>
												<div style="cursor:pointer" onclick="editmortgage(<?= $key->cma_id ?>,<?= $id ?>,<?= $key->id ?>)"><img align="center" src="<?= base_url() ?>images/edit-new.png"></div>
											</td>
											<td>
													...
													<tbody>
														...
														foreach ($cma_mortgage_security as $key1) { ?>
															<?php if ($key1->mortgage_id == $key->id) : ?>
																<tr>
																	<td>
																		<div style="cursor:pointer" onclick="delete_record_message('security_delete',<?= $key1->id ?>,<?= $key->cma_id ?>);"><img align="center" src="<?= base_url() ?>images/delete-New.png"></div>
																	</td>
																	<td>
																		<div style="cursor:pointer" onclick="editsecurity(<?= $key->cma_id ?>,<?= $id ?>,<?= $key->id ?>,<?= $key1->id ?>)"><img align="center" src="<?= base_url() ?>images/edit-new.png"></div>
																	</td>
																	<td>
...
<div id="sendToCheckerMessageDialogContent" style="display:none;">
	<div class="hd">
		<h2 class="conf" style="margin-top:0px">Do you want to <span id="send_message"></span>?</h2>
	</div>
