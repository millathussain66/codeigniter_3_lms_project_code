...
/* .center {
  ...
  padding: 10px;
    ...
    <script type="text/javascript">
            ...
            jQuery("#region").jqxComboBox({theme: theme, promptText: "Select Region", source: region, width: 150, height: 25});
            ...
            jQuery("#territory").jqxComboBox({theme: theme, promptText: "Select territory", source: territory, width: 150, height: 25});
            ...
            jQuery("#loan_segment").jqxComboBox({theme: theme, promptText: "Select Investment segment", source: loan_segment, width: 100, height: 25});
        ...
        success: function(response){
            var json = jQuery.parseJSON(response);
                    ...
                    if (operation=='region') 
                    {
                        ...
                        jQuery("#territory").jqxComboBox({theme: theme, autoDropDownHeight: false, promptText: "Select territory", source: territory, width: 150, height: 25});
                        //For edit action
                        if (edit!=null) 
                        {
                            //alert('success');
                    ...
                    if (operation=='territory') 
                    {
                        ...
                        jQuery("#district").jqxComboBox({theme: theme, autoDropDownHeight: false, promptText: "Select District", source: district, width: 150, height: 25});
                        //For edit action
                        if (edit!=null) 
                        {
                    ...
                    if (operation=='district') 
                    {
                        ...
                        jQuery("#unit_office").jqxComboBox({theme: theme, autoDropDownHeight: false, promptText: "Select Unit Office", source: unit_office, width: 150, height: 25});
                        //For edit action
                        if (edit!=null) 
                        {
                        ...
                        <div >
                            <div id='jqxTabs'>
                                ...
                                <div style="overflow: hidden;" class="back_image">
                                               ...
                                               <div  style="padding: 0px;width:100%;height: 115px;border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                                                    <table id="deal_body" style="display:block;width:90%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:5%"><div style="padding-left:1.8%" id="region" name="region"></div></td>
                                                            
                                                            <td style="text-align:right;width:10%"><strong>Territory</strong> </td>
                                                            <td style="width:5%"><div style="padding-left:1.8%" id="territory" name="territory"></div></td>
                                                            ...
                                                            <td style="width:5%"><div style="padding-left:1.8%" id="unit_office" name="unit_office"></div></td>
                                                            
                                                            <td style="text-align:right;width:5%"><strong>Protfolio</strong> </td>
                                                            <td style="width:8%;text-align: left;"><div style="padding-left:1.8%" id="loan_segment" name="loan_segment"></div></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="text-align:right;width:9%">LIMIT</td>
                                                            <td style="width:15%"><div style="padding-left:1.8%" id="limit" name="limit"></div></td>
                                                            
                                                            <td style="text-align:right;width:10%"><strong></strong> </td>
                                                            <td style="width:5%"></td>
                                    ...
                                    <div style="overflow:scroll;min-width: 1000px;width: 1125px;max-height: 320px;min-height: 300px;height: 300px;">
