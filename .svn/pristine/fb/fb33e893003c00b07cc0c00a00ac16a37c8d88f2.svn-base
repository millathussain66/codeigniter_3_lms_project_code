...
<body style="height:94%;">
	...
	<div style="padding:10px 10px;">
		...
		<a href="<?php echo base_url('auction/paperpdf/'.$id.'/'.$type);?>" target="_blank"><img align="center" src="<?=base_url()?>images/pdf_icon.gif"></a>&nbsp;
		 <a href="#" onclick="Export2Word('element')"><img align="center" src="<?=base_url()?>images/word_icon.gif"></a>
	</div>
