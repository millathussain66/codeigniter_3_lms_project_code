...
<script type="text/javascript">
    ...
    var final_remarks = [<? $i = 1;
                            foreach ($final_remarks as $row) {
                                if ($i != 1) {
                                    echo ',';
                                }
                                echo '{value:"' . $row->id . '", label:"' . $row->name . '"}';
    ...
    jQuery(document).ready(function() {
        ...
        jQuery("#not_available_sts").jqxCheckBox({
            width: 22,
            theme: theme,
            checked: false
        });
        ...
        jQuery("#next_date_purpose").jqxComboBox({
            theme: theme,
            autoOpen: false,
            autoDropDownHeight: false,
            promptText: "Select Purpose",
            source: case_sts,
            width: 250,
            height: 25
        });
        jQuery("#final_remarks").jqxComboBox({
            theme: theme,
            autoOpen: false,
            autoDropDownHeight: false,
            promptText: "Select Rmarks",
            source: final_remarks,
            width: 250,
            height: 25
        });
        ...
        jQuery('#case_sts').bind('change', function(event) {
            ...
            if (item != null) {
                ...
                if (item.value == <?= solenama() ?>) {
                    jQuery("#solenama_date_row").show();
                    jQuery("#probation_date_row").show();
                    jQuery("#document_upload_row").show();
                    jQuery("#court_fee_amount_row").show();
                } else {
                    jQuery("#solenama_date_row").hide();
                    jQuery("#probation_date_row").hide();
                    jQuery("#document_upload_row").hide();
                    jQuery("#court_fee_amount_row").hide();
                }
                ...
                columns: [{
                    ...
                    <? if (DELETE == 1) { ?> {
                            ...
                            cellsrenderer: function(row) {
                                ...
                                } else if (<?= DELETE ?> == '1' && (<?= $this->session->userdata['ast_user']['user_work_group_id'] ?> == 11 || <?= $this->session->userdata['ast_user']['user_work_group_id'] ?> == 10) && dataRecord.sts == 51) {
                    ...
                    <? if (EDIT == 1) { ?> {
                            ...
                            cellsrenderer: function(row) {
                                ...
                                } else if (<?= EDIT ?> == '1' && (<?= $this->session->userdata['ast_user']['user_work_group_id'] ?> == 11 || <?= $this->session->userdata['ast_user']['user_work_group_id'] ?> == 10)) {
    ...
    function make_default_block_field_list() {
        block_field_list = [
            ...
            'next_date_purpose####combo', 'district####combo',
            'plaintiff####combo', 'lawyer####combo',
            'court####combo', 'next_dt_remarks####input',
            'remarks####input'
        ];
    }
    ...
    function get_information_by_district() {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                jQuery("#plaintiff").jqxComboBox({
                    theme: theme,
                    autoOpen: false,
                    autoDropDownHeight: false,
                    promptText: "Select Plaintiff",
                    source: plaintiff,
                    width: 250,
                    height: 25
                });
    ...
    function edit(id, index, ho_edit_sts = null) {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                var item_case_sts = jQuery("#case_sts").jqxComboBox('getSelectedItem');
                ...
                jQuery("#case_number_div").html(json.row_info.case_number);


                tmpExpenseData = json.expense_data;
                ...
                if (json.Message == 'ok') {
                    ...
                    var html = '';
                    html += '<img style="cursor:pointer" src="<?= base_url() ?>/images/upload.png" alt="upload" title="Upload" onclick="CustomerPickList(\'cma\',\'solanama_document_upload\')"/>';
                    html += '<input type="hidden" id="hidden_solanama_document_upload_select" name="hidden_solanama_document_upload_select" value="0">';
                    html += '<span id="hidden_solanama_document_upload"></span><input type="hidden" id="optional_select_add_edit" name="solanama_document_upload_select_add_edit" value="add">';
                    jQuery('#solanama_document_upload').html(html);
                    ...
                    jQuery.each(json['expense_data'], function(key, obj) {
                        ...
                        html_string += '<td><input type="number"  step="any"  name="amount_' + new_counter + '" tabindex="" placeholder="" style="width:90%;" id="amount_' + new_counter + '" value="' + obj.amount + '" ><input type="text" name="p_cost_' + new_counter + '" tabindex="" placeholder="" style="width:90%;display:none" id="p_cost_' + new_counter + '" value="" onkeypress="return numbersonly(event)"></td>';
                        html_string += '<input type="hidden" name="original_amount_' + new_counter + '" tabindex="" placeholder="" style="width:90%;" id="original_amount_' + new_counter + '" value="' + obj.amount + '" >';
                    ...
                    jQuery('#solenama_date').val(json.result.solenama_date);
                    jQuery('#probation_date').val(json.result.probation_date);
                    jQuery('#court_fee_amount').val(json.result.court_fee_amount);


                    var solanama_document_upload = json.result.solanama_document_upload;

                    var new_html = '';


                    new_html += '<img style="cursor:pointer" src="<?= base_url() ?>/images/upload.png" alt="upload" title="Upload" onclick="CustomerPickList(\'cma\',\'solanama_document_upload\')"/>';
                    new_html += '<input type="hidden" id="hidden_solanama_document_upload_select" name="hidden_solanama_document_upload_select" value="0">';


                    if (solanama_document_upload != '' && solanama_document_upload != null) {
                        new_html += '<span id="hidden_solanama_document_upload"><img id="file_preview_solanama_document_upload" onclick="popup(\'<?= base_url() ?>cma_file/solanama_document_upload/' + solanama_document_upload + '\')" style=" cursor:pointer;text-align:center" height="18" src="<?= base_url() ?>old_assets/images/print-preview.png"></span>';
                        new_html += '<input type="hidden" id="hidden_solanama_document_upload_value" name="hidden_solanama_document_upload_value" value="' + solanama_document_upload + '">';
                        new_html += '<img id="file_delete_solanama_document_upload" onclick="file_delete(\'solanama_document_upload\')" src="<?= base_url() ?>images/delete-New.png" style=" cursor:pointer;"  alt="Delete" title="Delete">';
                        new_html += '<input type="hidden" id="file_delete_value_solanama_document_upload" name="file_delete_value_solanama_document_upload" value="0">';
                        new_html += '<span id="hidden_solanama_document_upload"></span><input type="hidden" id="optional_select_add_edit" name="solanama_document_upload_select_add_edit" value="edit">';

                    } else {
                        new_html += '<span id="hidden_solanama_document_upload"></span><input type="hidden" id="optional_select_add_edit" name="optional_select_add_edit" value="add">';
                    }



                    jQuery('#solanama_document_upload').html(new_html);
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                if (json.Message == 'ok') {
                    ...
                    html += '<td><input  name="amount_1" type="number" step="any" class="" style="width:90%;" id="amount_1" /></td>';
                    html += '<input  name="original_amount_1" type="hidden" class="" style="width:90%" id="original_amount_1" />';
                    if (json.package_sts == 1) //when package available
                    {
                    ...
                    jQuery("#expense_type_1").jqxComboBox({
                        theme: theme,
                        autoOpen: false,
                        autoDropDownHeight: false,
                    ...
                    jQuery("#activities_name_1").jqxComboBox({
                        theme: theme,
                        autoOpen: false,
                        autoDropDownHeight: false,
                        promptText: "Select Activity",
                    ...
                    jQuery('#vendor_id_1').jqxComboBox({
                        theme: theme,
                        width: 180,
                        autoOpen: false,
                        autoDropDownHeight: false,
    ...
    function add_more_expense() {
        ...
        html_string += '<td><input type="number"  step="any" step="any" name="amount_' + new_counter + '" tabindex="" placeholder="" style="width:90%;" id="amount_' + new_counter + '"  ></td>';
        html_string += '<input type="hidden"  name="original_amount_' + new_counter + '" tabindex="" placeholder="" style="width:90%;" id="original_amount_' + new_counter + '"  >';
    ...
    function get_expense_amount(act_id, counter) {
        ...
        var vendor_id = jQuery("#vendor_id_" + counter).jqxComboBox('getSelectedItem');
        var vendor_name = vendor_id.value;
        ...
        if (item2 != null && item2.value == 1) {
            if (item != null) {
                ...
                var csrfHash = jQuery('.txt_csrfname').val(); // CSRF hash
                jQuery.ajax({
                    url: '<?= base_url() ?>index.php/legal_status_expense/get_expense_amount',
                    async: false,
                    type: "post",
                    data: {
                        [csrfName]: csrfHash,
    ...
    function clear_form() {
        ...
        jQuery('#solenama_date').val('');
        jQuery('#probation_date').val('');
        jQuery('#solanama_document_upload').val('');
        jQuery('#court_fee_amount').val('');
                                ...
                                <div style="padding: 10px;">
                                    <div id="search_area">
                                        <form method="POST" name="form" id="form" style="margin:0px;">
                                            ...
                                            <div style="padding: 0px;width:100%;height:100px; border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                                                <table id="deal_body" style="display:block;width:100%">
                                                    ...
                                                    <tr>
                                                        <td style="text-align:left;width:11%"><strong>AC Name</strong></td>
                                                        <td style="width:15%"><input name="ac_name" tabindex="" type="text" class="" maxlength="16" size="16" style="width:120px" id="ac_name" value="" /></td>
                                                            ...
                                                            <td width="50%">
                                                                <table style="width: 100%;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="60%" style="font-weight: bold;"><span id="case_number_div"></span></td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="60%"><input type="text" name="case_dt" tabindex="3" onchange="check_hiliday('case_dt'),set_expense_date('case_dt')" placeholder="dd/mm/yyyy" style="width:250px;" id="case_dt" value="">
                                                                            <script type="text/javascript" charset="utf-8">
                                                                                datePicker_without_advance("case_dt");
                                                                            </script>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td width="60%">
                                                                            <div id="case_sts" name="case_sts" style="padding-left: 3px" tabindex="6"></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">Previous Remarks For Today</td>
                                                                    ...
                                                                    <tr id="next_sts_row">
                                                                        ...
                                                                        <td width="60%">
                                                                            <div id="next_date_purpose" name="next_date_purpose" style="padding-left: 3px" tabindex="5"></div>
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <td width="50%">
                                                                <table style="width: 100%;">
                                                                    <tr>
                                                                        ...
                                                                        <td width="60%">
                                                                            <div id="district" name="district" style="padding-left: 3px" tabindex="9"></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">Transfer To Other District Plaintiff</td>
                                                                        <td width="60%">
                                                                            <div id="plaintiff" name="plaintiff" style="padding-left: 3px" tabindex="8"></div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">New Lawyer Name</td>
                                                                        <td width="60%">
                                                                            <div id="lawyer" name="lawyer" style="padding-left: 3px" tabindex="1"></div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="60%">
                                                                            <div id="court" name="court" style="padding-left: 3px;float:left" tabindex="2"></div><input type="button" style="float:left;margin-left:5px;margin-top:4px" title="Add More" onClick="add_more_ref_data('ref_court')" class="addmore">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="40%" style="font-weight: bold;">Final Remarks</td>
                                                                        <td width="60%">
                                                                            <div id="final_remarks" name="final_remarks" style="padding-left: 3px" tabindex="9"></div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr id="solenama_date_row" style="display: none">
                                                                        <td width="40%" style="font-weight: bold;">Solanama Date<span style="color:red">*</span></td>
                                                                        <td width="60%">
                                                                            <input type="text" name="solenama_date" tabindex="4" onchange="check_hiliday('solenama_date')" placeholder="dd/mm/yyyy" style="width:225px;" id="solenama_date" value="">
                                                                            <script type="text/javascript" charset="utf-8">
                                                                                datePicker("solenama_date");
                                                                            </script>
                                                                        </td>
                                                                    </tr>


                                                                    <tr id="probation_date_row" style="display:none">
                                                                        <td width="40%" style="font-weight: bold;">Probation Date <span style="color:red">*</span></td>
                                                                        <td width="60%">
                                                                            <input type="text" name="probation_date" tabindex="4" onchange="check_hiliday('probation_date')" placeholder="dd/mm/yyyy" style="width:225px;" id="probation_date" value="">
                                                                            <script type="text/javascript" charset="utf-8">
                                                                                datePicker("probation_date");
                                                                            </script>
                                                                        </td>
                                                                    </tr>


                                                                    <tr id="document_upload_row" style="display:none">
                                                                        <td width="40%" style="font-weight: bold;">Solanama Document Upload<span style="color:red">*</span></td>
                                                                        <td width="60%">
                                                                            <span id="solanama_document_upload" name="solanama_document_upload"></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr id="court_fee_amount_row" style="display: none;">
                                                                        <td width="40%" style="font-weight: bold;">Court Fee Amount<span style="color:red">*</span> </td>
                                                                        <td width="60%"><input type="text" name="court_fee_amount" style="width:250px;" id="court_fee_amount"></script>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <table border="1" id="gurantor_table" cellspacing="0" cellpadding="5" style="border-collapse: collapse;border-color:#c0c0c0;width:97%;margin:20px">
                                                                        <thead>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="10%" style="font-weight: bold;text-align:center">Investment AC</td>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="float:left;padding-top: 5px;">
                                    <div style="font-family: Calibri; margin: 0 0 -10px 0;font-size:14px;color:#0000cc">
                                        <? if (VERIFY == 1) { ?>
                                            <a style="text-decoration:none" onclick="javascript:EOL.messageBoard.open(this.href, (jQuery(window).width()-70), jQuery(window).height(), 'yes'); return false;" href="<?= base_url() ?>index.php/legal_status_expense/bulk_operation/apv" title=""><input type="button" class="buttonStyle" style="background-color:#c2c2bc;font-size:13px;border-radius: 3px !important;height:30px;width:100px;" value="BULK APV" id="sendButton" /></a>
                                            <? } ?>&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    rules = [{
            ...
            rule: function(input) {
                if (input.val() != '') {
                    var item = jQuery("#case_sts").jqxComboBox('getSelectedItem');
                    if (item != null) {
                        jQuery("input[name='case_sts']").val(item.value);
                    }
                    return true;
                } else {
            ...
            rule: function(input) {
                if (jQuery("#next_case_dt").val() != '') {
                    if (input.val() != '') {
                        ...
                        if (item != null) {
                            jQuery("input[name='next_date_purpose']").val(item.value);
                        }
                        return true;
                    } else {
        ...
        {
            input: '#case_dt',
            message: 'above date from next date not allowed!',
            action: 'keyup, blur, change',
            rule: function(input, commit) {
        ...
        {
            input: '#case_dt',
            message: 'advance date not allowed!',
            action: 'keyup, blur, change',
            rule: function(input, commit) {
                if (jQuery("#case_dt").val() != '') {
                    var today = new Date();
        ...
        {
            input: '#next_case_dt',
            message: 'old date from case date not allowed!',
            action: 'keyup, blur, change',
            rule: function(input, commit) {
                if (jQuery("#next_case_dt").val() != '' && jQuery("#case_dt").val() != '' && jQuery("#next_dt_sts_value").val() == 1) {
                    return date_validation(jQuery("#next_case_dt").val(), jQuery("#case_dt").val());
        ...
        {
            input: '#next_case_dt',
            message: 'next date and present date same!',
            action: 'keyup, blur, change',
            rule: function(input, commit) {
                if (jQuery("#next_case_dt").val() != '' && jQuery("#case_dt").val() != '' && jQuery("#next_dt_sts_value").val() == 1) {
        ...
        },
        {
            ...
            rule: function(input, commit) {
                if (input.val() != "") {
                    return validatenewDate(input.val());
                } else {
                    return true;
                }
            }
    ...
    jQuery("#sendButton").click(function() {
        ...
        var item = jQuery("#case_sts").jqxComboBox('getSelectedItem');
        if (item != null && req_type == 99999999) {
        ...
        // New Here 
        var item = jQuery("#case_sts").jqxComboBox('getSelectedItem');
        if (item != null && item.value == <?= solenama(); ?>) {

            if (jQuery("#solenama_date").val() == '') {

                alert("Solename Date Require");
                return false;

            }
            if (jQuery("#probation_date").val() == '') {
                alert("Probation Date Date Require");
                return false;

            }
            if (jQuery("#court_fee_amount").val() == '') {
                alert("Court Fee Amount Date Date Require");
                return false;
            }

            if (jQuery("#hidden_solanama_document_upload_select").val() == '0') {
                alert('Please Upload Solanama Document Copy');
                return false;
            }
