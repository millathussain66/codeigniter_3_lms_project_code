...
function search_data(){
    ...
    else
    {
        ...
        jQuery.ajax({
            ...
            cache: false,
            async:false,
            url: "<?=base_url()?>index.php/wa_rt/month_wise_total_case_rt/",
            data : postdata,
            datatype: "html",
        ...
        <table class="">
            <tr id="widgetsNavigationTree">
                ...
                <td valign="top" id="demos" class='rc-all content'  style="width:85%;overflow: hidden;">
                    <div id="search_area">
                    <form method="POST" name="form" id="form" action="<?php echo base_url('wa_rt/month_wise_total_case_rt_xl'); ?>"  style="margin:0px;">
