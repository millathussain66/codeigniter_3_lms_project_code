...
<script type="text/javascript">
	...
	jQuery(document).ready(function($) {
		...
		jQuery('#req_type,#pre_auc_sts,#pre_case_type,#pre_case_sts,#disposal_sts,#chq_sts,#case_logic,#borr_sts,#busi_sts,#branch_sol,#sec_sts,#case_fill_dist,#guar_sts_1,#occ_sts_1,#guarantor_type_1,#zone,#district,#g_zone,#g_district,#proposed_type,#s_proposed_type,#loan_segment,#g_loan_segment,#sub_type,#g_status,#g_cl_bbl').focusout(function() {
		...
		var jqxgrid = function() {
			var source = {
				...
				url: '<?= base_url() . "index.php/cma_process/running_grid/" . $submenu ?>',
				cache: false,
				filter: function() {
	...
	function clear_form() {
		...
		jQuery("#district").val('');
		jQuery("#case_fill_dist").jqxComboBox('clearSelection');
		jQuery("#case_fill_dist").val('');
		jQuery("#sec_sts").jqxComboBox('clearSelection');
		jQuery("#sec_sts").val('');
		jQuery("#pre_auc_sts").jqxComboBox('clearSelection');
		...
		jQuery.ajax({
			...
			success: function(response) {
				...
				if (json.Message == 'ok') {
					...
					jQuery("#case_fill_dist").jqxComboBox('val', row.case_fill_dist);
			...
			<tr id="widgetsNavigationTree">
				...
				<td valign="top" id="demos" class='rc-all content'>
					...
					<div id="">
						<div id='jqxTabs'>
							<ul>
								<li style="margin-left: 30px;display:none;">Form</li>
								<li>Data Grid</li>
							</ul>
							<!---==== First Tab Start ==========----->
																	...
																	<tr>
																		...
																		<td width="60%">
																			...
																			<div style="background-color:#eaeaea;padding:10px;width:233px;display:none" id="spfm">
																				...
																				Mother Name<span style="color:red">*</span><br /><input name="mother_name" onblur="capitialize('mother_name')" tabindex="10" type="text" class="" style="width:225px" id="mother_name" value="" />
																			</div>
																		</td>
																	</tr>
																	<tr>
