...
/* .center {
  ...
  padding: 10px;
    ...
    <?php 
         ...
         $plaintiff =$this->User_model->get_parameter_data('users_info','name','data_status = 1 AND user_group_id IN (4,9) AND admin_status<>2');
    ...
    <script type="text/javascript">
            ...
            var recovery_am = [<? $i=1; foreach($recovery_am as $row){ if($i!=1){echo ',';} echo '{value:"'.$row->id.'", label:"'.$row->name.'('.$row->user_id.')"}'; $i++;}?>];
            ...
            jQuery("#recovery_am").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false,dropDownHeight: 100, promptText: "Recovery FM", source: recovery_am, width: 250, height: 25});
            ...
            jQuery("#zone").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false,dropDownHeight: 100, promptText: "Select zone", source: zone, width: 250, height: 25});
            jQuery("#loan_segment").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false,dropDownHeight: 100, promptText: "Investment Segment", source: loan_segment, width: 250, height: 25});
            jQuery("#branch_sol").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false,dropDownHeight: 100, promptText: "Branch Code", source: branch_sol, width: 250, height: 25});
           ...
           jQuery('#filling_plaintiff,#next_date_sts_grid,#proposed_type_grid,#req_type_grid,#related_authority,#case_sts,#proposed_type_f,#proposed_type,#branch_sol,#zone,#district,#proposed_type,#req_type,#req_type_f,#retail_branch,#prest_court_name,#prest_lawyer_name,#recovery_am,#case_name').focusout(function() {
           ...
           let date =  new Date().getFullYear();
            ...
            jQuery("#proposed_type_f").jqxComboBox('val','Investment');
                    ...
                    jQuery("#jqxgrid").jqxGrid(
                    {
                        ...
                        columns: [
                              ...
                              <? if(UPDATENEXTDATE==1){?>
                                ...
                                { text: 'zone', datafield: 'zone',editable: false, width: '10%', align:'left',cellsalign:'left'},
    ...
    function change_dropdown(operation,edit=null)
    {
        ...
        if (edit==null && operation!='court' && operation!='legal_zone' && operation!='legal_district_lawyer') 
        {
        ...
        else if(edit==null && operation=='legal_zone')
        {
            id = jQuery("#zone").val();
        }
        else
        ...
        jQuery.ajax({
            ...
            success: function(response){
                ...
                if(json.Message=='ok'){
                    ...
                    jQuery('#zone').jqxComboBox('val', json.suit_info.zone);
                    change_dropdown('legal_zone');
        ...
        if(item!=null)
        {
            if (item.value=='Investment') 
            {
                rules.push(
                    ...
                    { input: '#loan_ac_f', message: 'must be <?=loan_ac_count()?> digits', action: 'keyup, blur, change', rule: function (input, commit)
                     {
                        if(input.val() != '')
                        {
                                               ...
                                               <div style="padding: 0px;width:100%;height:50px; border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                                                    <table id="deal_body" style="display:block;width:100%">
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center;width:10%"><strong>Proposed Type&nbsp;&nbsp;</strong> </td>
                                                            ...
                                                            <td style="width:15%"><input name="loan_ac" tabindex="" type="text" class="" style="width:150px" id="loan_ac" value="" onKeyUp="javascript:return mask(this.value,this);"/></td>
                                                                ...
                                                                <td width="50%" style="display:contents;">
                                                                    <table style="width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" >
                                                                                <input name="loan_ac_f" tabindex="3" type="text" class="" style="width:195px" id="loan_ac_f" value="" onKeyUp="javascript:return mask2(this.value,this);" onblur="change_brunch()"/>
                                                                        ...
                                                                        <tr>
                                                                            <td width="40%" style="font-weight: bold;">Zone </td>
                                                                            <td width="60%" ><div id="zone" tabindex="10" name="zone" style="padding-left: 3px"></div></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="40%" style="font-weight: bold;">Branch (Code) </td>
                                                                ...
                                                                <td width="50%" >
                                                                    <table style="width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" ><input name="case_section" type="text" class="" style="width:250px" id="case_section" value="" /></td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td width="40%" style="font-weight: bold;">Recovery FM</td>
                                    ...
                                    <div style="padding: 0.5%;width:98%;height:50px; border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                                        ...
                                        <table id="deal_body" style="display:block;width:100%">
                                            <tr>
                                                ...
                                                <td style="width:10%"><input name="loan_ac_grid" tabindex="" type="text" class="" style="width:150px" id="loan_ac_grid" value="" onKeyUp="javascript:return mask_grid(this.value,this);"/></td>
