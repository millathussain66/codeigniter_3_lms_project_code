...
<script type="text/javascript">
    ...
    var appeal_bail_type = [<? $i = 1;
                            foreach ($appeal_bail_type as $row) {
                                if ($i != 1) {
                                    echo ',';
                                }
    ...
    jQuery(document).ready(function() {
        ...
        jQuery("#appeal_bail_type").jqxComboBox({
            theme: theme,
            autoOpen: false,
            autoDropDownHeight: false,
            promptText: "Select Type",
            source: appeal_bail_type,
            width: 250,
            height: 25
        });
...

                {
                    ...
                    rule: function(input, commit) {
                        if (input.val() != '') {
                            ...
                            if (item != null) {
                                jQuery("input[name='arrested']").val(item.value);
                            }
                            return true;
                        } else {
                ...
                },
                {
                    ...
                    rule: function(input, commit) {
                        if (input.val() != '') {
                            ...
                            if (item != null) {
                                jQuery("input[name='appeal_bail_type']").val(item.value);
                            }
                            return true;
                        } else {
        ...
        var initGrid2 = function() {
            var source = {
                ...
                datafields: [{
                    ...
                    {
                        name: 'appeal_bail_type_name',
                        type: 'string'
                    },
                    {
                        name: 'case_claim_amount',
                        type: 'string'
                    },
                    {
            ...
            jQuery("#jqxGrid2").jqxGrid({
                ...
                columns: [
                    ...
                    {
                        text: 'Type',
                        datafield: 'appeal_bail_type_name',
                        editable: false,
                        width: '13%'
                    },
                    {
                        text: 'Case Claim Amount',
                        datafield: 'case_claim_amount',
                        editable: false,
                        width: '13%'
                    },
                    {
                        text: 'Total Deposite %',
                        datafield: 'deposit_percent',
                        editable: false,
                        width: '13%'
                    },
                    {
                        text: 'Pending Deposite %',
            ...
            jQuery("#details").jqxWindow({
                ...
                isModal: true,
                autoOpen: false,
                cancelButton: jQuery("#r_ok,#deletecancel,#SendTocheckercancel,#verifycancel,#sendtocheckercancel")
            });
    ...
    // Add New table Row Customization
    ...
    jQuery(document).ready(function() {
        ...
        var new_counter = 1;
        guarantor_html = '';
        guarantor_html += '<tr id="guarantor_info_' + new_counter + '">';
        guarantor_html += '<td style="text-align:center">';
        guarantor_html += '<input type="hidden" id="guarantor_info_edit_' + new_counter + '" name="guarantor_info_edit_' + new_counter + '" value="0">';
        guarantor_html += '<input type="hidden" id="guarantor_info_delete_' + new_counter + '" name="guarantor_info_delete_' + new_counter + '" value="0">';

        guarantor_html += '</td>';
        guarantor_html += '<td>';
        guarantor_html += '<input name="upload_file_caption_' + new_counter + '" type="text" style="width:100%" id="upload_file_caption_' + new_counter + '" />';
        guarantor_html += '</td>';

        guarantor_html += '<td><img style="cursor:pointer" src="<?= base_url() ?>/images/upload.png" alt="upload" title="Upload" onclick="CustomerPickList(\'cma\',\'appeal_bail_scan_copy_' + new_counter + '\')"/>';
        guarantor_html += '<input type="hidden" id="hidden_appeal_bail_scan_copy_' + new_counter + '_select" name="hidden_appeal_bail_scan_copy_' + new_counter + '_select" value="0">';
        guarantor_html += '<span id="hidden_appeal_bail_scan_copy_' + new_counter + '">';
        guarantor_html += '<span id="appeal_bail_scan_copy_' + new_counter + '" name="appeal_bail_scan_copy_' + new_counter + '"></span> </td>';

        guarantor_html += '<tr>';
        jQuery('#guarantor_info_body').html(guarantor_html);
    ...
    function add_more_owner() {
        ...
        html_string += '<td>';
        html_string += '<input name="upload_file_caption_' + new_counter + '" type="text" style="width:100%" id="upload_file_caption_' + new_counter + '" />';
        ...
        html_string += '<td><img style="cursor:pointer" src="<?= base_url() ?>/images/upload.png" alt="upload" title="Upload" onclick="CustomerPickList(\'cma\',\'appeal_bail_scan_copy_' + new_counter + '\')"/>';
        html_string += '<input type="hidden" id="hidden_appeal_bail_scan_copy_' + new_counter + '_select" name="hidden_appeal_bail_scan_copy_' + new_counter + '_select" value="0">';
        html_string += '<span id="hidden_appeal_bail_scan_copy_' + new_counter + '">';
        html_string += '<span id="appeal_bail_scan_copy_' + new_counter + '" name="appeal_bail_scan_copy_' + new_counter + '"></span> </td>';
                                    ...
                                    <form class="form" name="action_form" id="action_form" method="post" action="<?= base_url() ?>index.php/appeal_bail_money/add_edit_action" enctype="multipart/form-data">
                                        ...
                                        <table style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    <div id="appeal_bail_type" name="appeal_bail_type"></div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%"><input name="deposite_date" type="text" class="" style="width:250px" id="deposite_date" value="" placeholder="dd/mm/yyyy" />
                                                    <script>
                                                        datePicker("deposite_date");
                                                    </script>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    <div id="arrested" name="arrested" style="padding-left: 3px"></div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    ...
                                                    <table id="file_upload_table" border="">
                                                    <input type="hidden" name="guarantor_info_counter" id="guarantor_info_counter" value="1">

                                                        <thead>
                                                            <tr>
                                                                <td width="10px" style="font-weight: bold;text-align:center">Del</td>
                                                                <td width="180px" style="font-weight: bold;text-align:center">File Caption</td>
                                                                <td width="10px" style="font-weight: bold;text-align:center">Upload</td>
                                                            </tr>
                                                        </thead>
                                                        <input type="hidden" name="guarantor_info_counter_edit" id="guarantor_info_counter_edit" value="0">
