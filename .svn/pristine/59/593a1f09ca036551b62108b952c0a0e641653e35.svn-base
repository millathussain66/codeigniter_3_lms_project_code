...
function edit(id,editrow,edit='edit'){
    ...
    jQuery.ajax({
        ...
        success: function(response){
            ...
            jQuery("#memo_no").val(rows[0].memo_no);
            jQuery("#date_of_decree").val(rows[0].date_of_decree);
            jQuery("#fine_amount").val(rows[0].fine_amount);
            jQuery("#impresonment_month").val(rows[0].impresonment_month);
            jQuery("#debtor_name").val(rows[0].debtor_name);
            jQuery("#remarks").val(rows[0].remarks);
            jQuery("#sharok_no").val(rows[0].sharok_no);
            jQuery("#ps_name").val(rows[0].ps_name);
...
function xl_download(){
        ...
        jQuery.ajax({
            type: "POST",
            cache: false,
            url: '<?=base_url()?>index.php/warrant_arrest/mk_xl_executed_report',
            data : postData,
            datatype: "json",
            success: function(data){
              ///console.log(response);
                ...
                a.attr("download","WA_executed_Report.xls");
                        ...
                        <div style="overflow: hidden;_overflow-y: scroll;">
                            ...
                            <form class="form" name="action_form" id="action_form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <td width="20%" style="font-weight: bold;">Execution Criteria </td>
