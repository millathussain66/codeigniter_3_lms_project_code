...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        jQuery("#branch_sol").jqxDropDownList({
            theme: theme,
            checkboxes: true,
            autoDropDownHeight: false,
            promptText: "Suit Branch",
            filterable: true,
        ...
        jQuery('#zone,#loan_segment,#district').focusout(function() {
        ...
        jQuery("#req_type").jqxDropDownList({
            theme: theme,
            checkboxes: true,
            autoDropDownHeight: false,
            promptText: "Suit Nature",
            filterable: true,
            searchMode: 'containsignorecase',
            source: req_type,
            width: 140,
    ...
    function change_caption() {
        if (jQuery("#proposed_type").val() == '') {
            ...
            if (item.value == 'Investment') {
                jQuery("#l_or_c_no").html('Investment ');
    ...
    function change_dropdown(operation, edit = null) {
        ...
        if (edit == null && operation != 'legal_zone') {
    ...
    function add_additional_info(val) {
        EOL.messageBoard.open('<?= base_url() ?>Legal_file_process/from/' + val, (jQuery(window).width() - 70), jQuery(window).height(), 'yes');
        return false;
    }
    function download_additional_info(val) {
        var redirectUrl = "<?=base_url()?>Legal_file_process/download_additional_info/"+val;
        window.location.href = redirectUrl;
    }



    function add_warrantform(val) {
        EOL.messageBoard.open('<?= base_url() ?>Legal_file_process/add_warrantform/' + val, (jQuery(window).width() - 70), jQuery(window).height(), 'yes');
        return false;
    }


    function download_warrantform(val) {
        var redirectUrl = "<?=base_url()?>Legal_file_process/download_warrantform/"+val;
        window.location.href = redirectUrl;
    }
                            ...
                            <div style="overflow: hidden;" class="back_image">
                                <div style="padding: 10px;">
                                    <div id="suit_form_div" style="">
                                        <div id="print_button_div" width="100%" style="text-align:center">
                                            <input name="print" id="print" onclick="printDiv('suit_form_area')" value="Print" type="button">
                                        </div>
                            ...
                            <div style="overflow:hidden;" class="back_image">
                                <div id="search_area" style="">
                                    <form method="POST" name="form" id="form" style="margin:0px;" action="<?php echo base_url('legal_file_process/make_xl'); ?>">
                                        ...
                                        <div style="padding: 0px;width:100%;height: 115px;border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                                            <table id="deal_body" style="display:block;width:90%">
                                                <tr>
                                                    ...
                                                    <td style="text-align:right;width:5%"><input type='button' class="buttonStyle" id='grid_search' name='grid_search' value='Search' onclick="searchsuit()" style="background-color:#fff;color:#000;border-radius: 20px !important;height:30px;width:80px;font-family: sans-serif;font-size: 16px;border: 1px solid #29cdff;" />
                                                        <span id="grid_loading" style="display:none"><img src="<?= base_url() ?>images/loader.gif" align="bottom"></span>

                                                    </td>
                                                    <td style="text-align:left;width:8%"><button type='submit' formtarget="_blank" name='xl_search' id="xl_search" value='Search' style="width:58px;border: none;background: transparent"><img src="<?= base_url() ?>images/icon_xls.gif" width="20px" height="20px"></button></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align:right;width:10%"><strong>Zone</strong> </td>
                                                    <td style="width:5%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:right;width:10%"><strong>Branch</strong> </td>
                                                    <td style="width:5%">
                                                        <div style="padding-left:1.8%" id="branch_sol" name="branch_sol"></div>
                                                    </td>
                                ...
                                <div id="" style="overflow:scroll;min-width: 1000px;width: 1125px;max-height: 320px;min-height: 300px;height: 300px;">
                                    <table class="" table border="1" id="facility_table" style="border-color:#c0c0c0;">
                                        <thead>
                                            <tr>
                                                <td style="font-weight: bold;text-align:center">P</td>

                                                <?php if (ADDADDITIONAINFO == 1) { ?> 
                                                 <td style="font-weight: bold;text-align:center;white-space: nowrap;">Add 33/5 And 33/7</td>
                                                <?php } ?>
                                                <?php if (ADDADDITIONAINFO_DOWNLOAD == 1) { ?> 
                                                    <td style="font-weight: bold;text-align:center;white-space: nowrap;">33/5 And 33/7 Download</td>
                                                <?php } ?>
                                                <?php if (WARRANTFORM == 1) { ?> 
                                                 <td style="font-weight: bold;text-align:center;white-space: nowrap;">Warrant Form</td>
                                                <?php } ?>
                                                <?php if (WARRANTFORMDOWNLOAD == 1) { ?> 
                                                    <td style="font-weight: bold;text-align:center;white-space: nowrap;">Warrant Form Download</td>
                                                <?php } ?>
                                                ...
                                                <td style="font-weight: bold;text-align:center;word-wrap: break-word;">Branch Name</td>
