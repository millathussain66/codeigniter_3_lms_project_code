...
class Legal_affairs extends CI_Controller {
	...
	function view ($menu_group,$menu_cat,$menu_link=null,$submenu=null)
	{
		...
		$data = array(
			...
			'dealing_officer'=>$this->User_model->get_parameter_data('users_info','name','data_status = 1 AND user_group_id IN (20)'),
                            ...
                            <td width="50%" style="display:contents;">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td width="60%" >'.$suit_file_details->zone_name.'</td>
                                    </tr> 
                                    <tr>
	...
	function make_xl()
	{
        ...
        {
            $str_where .=" AND s.zone='".$this->session->userdata['ast_user']['zone']."'";
        }
        ...
        lr.name as zone,ls.name as loan_segment,s.remarks
	        ...
	        $headings4 = array('Sl No','A/C Number','A/C Name',
	    		'3 Type of case',
	        	'Type Of Case','Filling Date','Case Number','Previous Date','Case Status On The Previous','District','zone','Protfolio','Final Remarks');//,strtotime($dealdate)));
	    	...
	    	if (!empty($suit_file_details)) 
	    	{
	    		...
	    		$str .='<table style="width: 100%;" id="preview_table">
					...
					<tbody id="details_body">
						...
						<tr>
							<td width="50%" align="left"><strong>Investment Segment (Portfolio):</strong>'.$suit_file_details->loan_segment.'</td>
							<td width="50%" align="left"><strong>Case Number:</strong>'.$suit_file_details->case_number.'</td>
						</tr>
						<tr>
							<td width="50%" align="left"><strong>zone:</strong>'.$suit_file_details->zone.'</td>
